...
- **Python 3.12** (Azure default runtime — 100% test pass rate across 201 tests)
...
The wheel target maps `backend/src/awa` directly to the `awa` package in the distribution wheel:
