...
class PortfolioWorkflowSummary:
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "business_consequence": self.criticality_business_consequence,
            "dependency_impact": self.criticality_dependency_impact,
            "affected_scope": self.criticality_affected_scope,
            "migration_implication": self.criticality_migration_implication,
